...
export function AppHeader({ onMenuOpen }: AppHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-20 flex items-center justify-between border-b border-[#242424] bg-[#050505]/95 px-4 py-6 backdrop-blur-md lg:hidden">
      <div className="flex min-w-0 flex-1 items-center gap-3">
        ...
        <Link href="/dashboard" className="inline-flex min-w-0 flex-1">
          <NexusLogo size="xl" className="max-w-[min(85vw,420px)]" />
        </Link>
      </div>
