    ...
    <section className="border-b border-[#242424] px-4 py-14 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <span className="w-fit rounded-md border border-[#242424] px-2 py-1 text-xs text-[#A3A3A3]">
            Updated continuously
          </span>
        </div>

        <ul className="divide-y divide-[#242424] rounded-xl border border-[#242424] bg-[#0E0E0E]">
